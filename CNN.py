...
class LeNetConvPoolLayer(object):
    ...
    def __init__(self, rng, input, filter_shape, image_shape, poolsize=(2, 2)):
        ...
        #conv_out:(batch size, nb filters, output row, output col)
...
# 4D output tensor is thus of shape (20,20,12,12) so, batch_size=20
...
# 4D output tensor is thus of shape (20,50,4,4) so, batch_size=20
...
# This will generate a matrix of shape (20, 32 * 4 * 4) = (20, 512) 应该是(20* 50 * 4 * 4)
